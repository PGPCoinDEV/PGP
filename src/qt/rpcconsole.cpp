...
/**
 * Split prettygoodprivacy command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the PrettyGoodPrivacy RPC console.") + "<br>" +
