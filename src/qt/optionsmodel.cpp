...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizePrettyGoodPrivacyAmount"))
        settings.setValue("nAnonymizePrettyGoodPrivacyAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizePrettyGoodPrivacyAmount = settings.value("nAnonymizePrettyGoodPrivacyAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizePrettyGoodPrivacyAmount"))
        SoftSetArg("-anonymizePrettyGoodPrivacyamount", settings.value("nAnonymizePrettyGoodPrivacyAmount").toString().toStdString());
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizePrettyGoodPrivacyAmount:
            nAnonymizePrettyGoodPrivacyAmount = value.toInt();
            settings.setValue("nAnonymizePrettyGoodPrivacyAmount", nAnonymizePrettyGoodPrivacyAmount);
            emit anonymizePrettyGoodPrivacyAmountChanged(nAnonymizePrettyGoodPrivacyAmount);
            break;
#ifdef USE_NATIVE_I2P
        case I2PUseI2POnly:
        {
