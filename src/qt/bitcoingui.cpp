    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("PrettyGoodPrivacy") + " - " + tr("Wallet"));
    qApp->setStyleSheet("QMainWindow { background-image:url(:images/splash2);border:none; } #frame { } QToolBar QLabel { padding-top: 0px;padding-bottom: 0px;spacing: 10px;} QToolBar QLabel:item { padding-top: 0px;padding-bottom: 0px;spacing: 10px;} #toolbar2 { border:none;width:0px;hight:0px;padding-top:40px;padding-bottom:0px; background-color: transparent; } #labelMiningIcon { padding-left:5px;font-family:Century Gothic;width:100%;font-size:10px;text-align:center; color: blue; } QMenu { background-color: transparent; color: blue; padding-bottom:10px; } QMenu::item { color: blue; background: white; } QMenu::item:selected { background-color: white; } QMenuBar { background-color: white; color: blue; } QMenuBar::item { font-size:12px;padding-bottom:3px;padding-top:3px;padding-left:15px;padding-right:15px;color: blue; background-color: transparent; } QMenuBar::item:selected { background-color: transparent; }");
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/prettygoodprivacy"));
    setWindowIcon(QIcon(":icons/prettygoodprivacy"));
#else
    //setUnifiedTitleAndToolBarOnMac(true);
    QApplication::setAttribute(Qt::AA_DontShowIconsInMenus);
#endif
    setObjectName("prettygoodprivacy");
    setStyleSheet("#prettygoodprivacy { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    if (!fUseBlackTheme)
    {
        ...
        {
            progressBar->setStyleSheet("QProgressBar { color: #2DF8FB;  background: transparent; border: 1px solid blue; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: transparent; margin: 0px; }");
        }
    }
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Dashboard"), this);
    overviewAction->setToolTip(tr("Show general overview of wallet"));
    overviewAction->setCheckable(true);
    overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    tabGroup->addAction(overviewAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Receive"), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving payments"));
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(receiveCoinsAction);

    sendCoinsAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Send"), this);
    sendCoinsAction->setToolTip(tr("Send coins to a PrettyGoodPrivacy address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(sendCoinsAction);

    historyAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Transactions"), this);
    historyAction->setToolTip(tr("Browse transaction history"));
    historyAction->setCheckable(true);
    historyAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_4));
    tabGroup->addAction(historyAction);

    addressBookAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Addresses"), this);
    ...
    messageAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Messages"), this);
    messageAction->setToolTip(tr("View and Send Encrypted messages"));
    messageAction->setCheckable(true);
    tabGroup->addAction(messageAction);

   
    blockAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Block Explorer"), this);
    ...
    aboutAction = new QAction(tr("&About PrettyGoodPrivacy"), this);
    aboutAction->setToolTip(tr("Show information about PrettyGoodPrivacy"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for PrettyGoodPrivacy"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: blue; font-weight:bold;} QToolButton:hover { background-color: transparent } QToolButton:checked { background-color: transparent } QToolButton:pressed { background-color: transparent } #tabs { color: blue; background-color: transparent;  }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("PrettyGoodPrivacy client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PrettyGoodPrivacy client"));
...
void BitcoinGUI::setNumI2PConnections(int count)
{
    ...
    labelI2PConnections->setToolTip(tr("%n active connection(s) to I2P-PrettyGoodPrivacy network", "", count));
}
#endif
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PrettyGoodPrivacy network", "", count));
}
...
{
    QString strTitle = tr("PrettyGoodPrivacy") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid PrettyGoodPrivacy address or malformed URI parameters."));
    }
