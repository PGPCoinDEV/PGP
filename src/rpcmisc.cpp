...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <prettygoodprivacyaddress>\n"
            "Return information about <prettygoodprivacyaddress>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <prettygoodprivacypubkey>\n"
            "Return information about <prettygoodprivacypubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <prettygoodprivacyaddress> <signature> <message>\n"
