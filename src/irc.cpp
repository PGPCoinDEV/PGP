...
void ThreadIRCSeed()
{
    ...
    RenameThread("prettygoodprivacy-ircseed");
...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #prettygoodprivacycoinTEST\r");
            Send(hSocket, "WHO #prettygoodprivacycoinTEST\r");
        } else
        {
	    LogPrintf("JOIN #prettygoodprivacycoin\n");
            // randomly join #prettygoodprivacycoin00-#prettygoodprivacycoin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #prettygoodprivacycoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #prettygoodprivacycoin%02d\r", channel_number).c_str());
        };
